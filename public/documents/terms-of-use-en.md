...
- **"Entry"**: A record submitted to the Platform about a tenant
- **"Listed Person"**: An individual whose information appears in our database
...
### 3.2 Account Types
The Platform recognizes two equally privileged user categories with identical rights:
- **Landlords/Property Managers**: Individuals who rent out properties
- **Tenants**: Individuals who rent properties

Both categories have the same rights:
- To search the database
- To submit entries (when contractually authorized)
- To access detailed information about listed persons

### 3.3 Account Holder Responsibilities
...
### 5.1 Truthfulness Obligation
You must:
- Provide truthful and accurate information
- Update information when circumstances change
- Promptly correct any errors when discovered

### 5.2 Prohibited Activities
You must NOT:
- Submit false, misleading, or defamatory information
- Use the Platform for harassment or discrimination
- Attempt to access others' accounts
- Circumvent security measures
- Submit entries without proper contractual consent
...
**Email:** legal@wohnnomade.com
**Website:** www.wohnnomade.com

---

**By clicking "I Accept" or by using the Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms of Use.**
